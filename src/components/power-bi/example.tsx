...
export default function PowerBIReportJot() {
  const [loaded, setLoaded] = useState(false);
  const embedUrl = process.env.NEXT_PUBLIC_POWERBI_JOT_REPORT_EMBED_URL;
  ...
  if (!embedUrl) {
    return (
      <div className="p-4 rounded-xl border border-dashed border-gray-300 dark:border-gray-700 text-gray-500 dark:text-gray-400 text-center">
        Power BI embed URL is not configured. Set NEXT_PUBLIC_POWERBI_JOT_REPORT_EMBED_URL in your environment.
      </div>
    );
  }
