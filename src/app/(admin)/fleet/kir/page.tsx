...
export default function Home() {
  ...
  const statusBadge = (status: string) => {
    ...
    return "bg-gray-500/20 text-gray-500 dark:text-gray-400 border border-gray-500/30";
  };

  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 text-white p-8">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          <Truck className="w-8 h-8 text-yellow-400" />
          <div>
            <h1 className="text-gray-500 dark:text-gray-400 text-md mt-1 font-bold">Monitoring KIR Armada Truk</h1>
        ...
        <span className="flex items-center gap-2 bg-red-500/20 text-red-400 border border-red-500/30 px-3 py-1.5 rounded-lg text-sm">
